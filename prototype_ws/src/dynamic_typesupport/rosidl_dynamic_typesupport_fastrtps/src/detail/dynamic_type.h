...
rosidl_dynamic_typesupport_dynamic_type_impl_t *
fastrtps__dynamic_type_init_from_description(rosidl_dynamic_typesupport_serialization_support_impl_t * serialization_support_impl, type_description_t * description);
