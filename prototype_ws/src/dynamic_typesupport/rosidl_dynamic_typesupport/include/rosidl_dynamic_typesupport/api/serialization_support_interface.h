...
struct rosidl_dynamic_typesupport_serialization_support_interface_s
{
  ...
  // void (* insert_int8_value)(rosidl_dynamic_typesupport_serialization_support_impl_t * impl, rosidl_dynamic_typesupport_dynamic_data_impl_t * data, int8_t value, rosidl_dynamic_typesupport_member_id_t * out_id);
  // void (* insert_uint8_value)(rosidl_dynamic_typesupport_serialization_support_impl_t * impl, rosidl_dynamic_typesupport_dynamic_data_impl_t * data, uint8_t value, rosidl_dynamic_typesupport_member_id_t * out_id);
