...
{
  return (serialization_support->interface->dynamic_type_equals)(serialization_support->impl, dynamic_type->impl, other->impl);
}
...
{
  return (serialization_support->interface->get_dynamic_type_member_count)(serialization_support->impl, dynamic_type->impl);
}
...
{
  (serialization_support->interface->struct_type_builder_fini)(serialization_support->impl, dynamic_type_builder->impl);
...
rosidl_dynamic_typesupport_dynamic_type_build_struct_type(rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder)
{
  ...
  out->impl = (serialization_support->interface->build_struct_type)(serialization_support->impl, dynamic_type_builder->impl);
  return out;
}
...
{
  (serialization_support->interface->dynamic_type_fini)(serialization_support->impl, dynamic_type->impl);
  free(dynamic_type);
}
...
{
  (serialization_support->interface->add_bool_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_byte_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_char_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_float32_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_float64_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_int8_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_uint8_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_int16_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_uint16_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_int32_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_uint32_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_int64_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_uint64_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_string_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_wstring_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_bounded_string_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bounded_wstring_member(
  ...
  rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_bounded_wstring_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
{
  (serialization_support->interface->add_bool_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_byte_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_byte_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_char_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_char_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float32_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_float32_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float64_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_float64_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int8_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int8_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint8_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint8_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int16_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int16_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint16_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint16_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int32_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int32_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint32_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint32_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int64_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int64_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint64_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint64_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_string_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_string_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_wstring_array_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_wstring_array_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
{
  (serialization_support->interface->add_bounded_string_array_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bounded_wstring_array_member(
  ...
  uint32_t str_bound, uint32_t bound)
{
  (serialization_support->interface->add_bounded_wstring_array_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bool_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_bool_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_byte_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_byte_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_char_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_char_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float32_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_float32_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float64_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_float64_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int8_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_int8_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint8_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_uint8_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int16_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_int16_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint16_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_uint16_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int32_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_int32_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint32_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_uint32_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int64_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_int64_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint64_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_uint64_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_string_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_string_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_wstring_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name)
{
  (serialization_support->interface->add_wstring_unbounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name);
}
...
{
  (serialization_support->interface->add_bounded_string_unbounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bounded_wstring_unbounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t str_bound)
{
  (serialization_support->interface->add_bounded_wstring_unbounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bool_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_bool_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_byte_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_byte_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_char_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_char_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float32_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_float32_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_float64_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_float64_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int8_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int8_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint8_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint8_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int16_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int16_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint16_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint16_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int32_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int32_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint32_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint32_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_int64_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_int64_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_uint64_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_uint64_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_string_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_string_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_wstring_bounded_sequence_member(
  rosidl_dynamic_typesupport_serialization_support_t * serialization_support, rosidl_dynamic_typesupport_dynamic_type_builder_t * dynamic_type_builder, rosidl_dynamic_typesupport_member_id_t id, const char * name, uint32_t bound)
{
  (serialization_support->interface->add_wstring_bounded_sequence_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bounded_string_bounded_sequence_member(
  ...
  uint32_t str_bound, uint32_t bound)
{
  (serialization_support->interface->add_bounded_string_bounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound, bound);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_bounded_wstring_bounded_sequence_member(
  ...
  uint32_t str_bound, uint32_t bound)
{
  (serialization_support->interface->add_bounded_wstring_bounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, str_bound, bound);
}
...
{
  (serialization_support->interface->add_nested_struct_member)(serialization_support->impl, dynamic_type_builder->impl, id, name, nested_struct->impl);
}
...
{
  (serialization_support->interface->add_nested_struct_array_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, nested_struct->impl, bound);
}
...
{
  (serialization_support->interface->add_nested_struct_unbounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, nested_struct->impl);
}
...
rosidl_dynamic_typesupport_dynamic_type_add_nested_struct_bounded_sequence_member(
  ...
  rosidl_dynamic_typesupport_dynamic_type_t * nested_struct, uint32_t bound)
{
  (serialization_support->interface->add_nested_struct_bounded_sequence_member)(
    serialization_support->impl, dynamic_type_builder->impl, id, name, nested_struct->impl, bound);
}
